...
/**
 * Created by zenghui on 2017/5/11.
 */
...
public class CircleProgressView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setColor(Color.parseColor("#F76C1B"));
        ...
        mPaint.setTextSize(getResources().getDimensionPixelSize(R.dimen.public_textsize_value_18));
